...
export const calendarViewHtml = `
    <div id="news-panel" class="hidden flex-col gap-4 h-[calc(100dvh-120px)] min-h-[600px] animate-fade-in">
        <div class="glass-panel p-4 rounded-2xl h-full flex flex-col gap-3">
            <div class="flex items-center gap-2 border-b border-slate-800/80 pb-3 shrink-0">
                <span class="size-2.5 bg-yellow-400 rounded-full animate-pulse"></span>
