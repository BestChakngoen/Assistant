    ...
    <div id="networth-panel" class="hidden flex-1 flex-col space-y-6">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-slate-900/60 p-5 rounded-2xl border border-slate-800/80">
            ...
            <div class="flex items-center gap-3">
                <span id="nw-cloud-status" class="text-xs font-mono text-green-400 bg-green-500/10 px-3 py-1.5 rounded-xl border border-green-500/20 font-bold flex items-center gap-1.5">
            ...
            <div class="lg:col-span-1 glass-panel p-6 rounded-2xl border-0 flex flex-col gap-4">
                ...
                <div>
                    ...
                    <input type="text" id="nw-input-name" placeholder="e.g. Savings Account, Apple Stock, Car Loan"
                        class="w-full px-3.5 py-2.5 bg-slate-900/90 border border-slate-800/80 rounded-xl text-slate-200 text-xs font-mono focus:border-emerald-500 focus:outline-none">
                </div>
                ...
                <div class="grid grid-cols-2 gap-3">
                    <div>
                        ...
                        <select id="nw-input-type" class="w-full px-3 py-2.5 bg-slate-900/90 border border-slate-800/80 rounded-xl text-slate-200 text-xs font-mono focus:border-emerald-500 focus:outline-none">
                    ...
                    <div>
                        ...
                        <select id="nw-input-category" class="w-full px-3 py-2.5 bg-slate-900/90 border border-slate-800/80 rounded-xl text-slate-200 text-xs font-mono focus:border-emerald-500 focus:outline-none">
                ...
                <div>
                    ...
                    <input type="number" id="nw-input-amount" placeholder="0.00" min="0" step="0.01"
                        class="w-full px-3.5 py-2.5 bg-slate-900/90 border border-slate-800/80 rounded-xl text-emerald-400 text-sm font-mono font-bold focus:border-emerald-500 focus:outline-none tabular-nums">
                </div>
                ...
                <div>
                    <div class="flex items-center justify-between mb-4">
                        <h3 class="font-mono font-bold text-sm text-slate-300 flex items-center gap-2">
                            <i data-lucide="list" class="size-4 text-cyan-400"></i>
                            <span>PORTFOLIO ASSETS & LIABILITIES</span>
                        </h3>
                        <div class="flex gap-2">
                            <button id="nw-filter-all" class="px-3 py-1.5 text-xs font-mono font-bold rounded-lg bg-cyan-500/20 text-cyan-400 transition">ALL</button>
                            <button id="nw-filter-asset" class="px-3 py-1.5 text-xs font-mono font-bold rounded-lg bg-slate-800 text-slate-400 hover:text-emerald-400 transition">ASSETS</button>
                            <button id="nw-filter-liability" class="px-3 py-1.5 text-xs font-mono font-bold rounded-lg bg-slate-800 text-slate-400 hover:text-red-400 transition">LIABILITIES</button>
                        </div>
                    </div>
